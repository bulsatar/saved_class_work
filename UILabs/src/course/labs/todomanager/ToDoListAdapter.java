...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (toDoItem.getPriority()==Priority.HIGH){priorityView.setText("High");}
		if (toDoItem.getPriority()==Priority.MED){priorityView.setText("Medium");}
		if (toDoItem.getPriority()==Priority.LOW){priorityView.setText("Low");}
